# VS Code Snippets via .dotfiles

Place your snippets for erb here. Each snippet is defined under a snippet name and has a prefix, body and description. The prefix
